...
HD_PWD='D:/SATHISH VLSI Projects/AES-SHA-512 Advanced/project_1/project_1.runs/spdif_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spdif_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spdif_0.tcl
