...
HD_PWD='D:/SATHISH VLSI Projects/AES-SHA-512 Advanced/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hybrid_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hybrid_top.tcl -notrace
