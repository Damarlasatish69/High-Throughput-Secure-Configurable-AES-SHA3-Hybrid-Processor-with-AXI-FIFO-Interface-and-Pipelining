...
HD_PWD='D:/SATHISH VLSI Projects/AES-SHA-512 Advanced/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hybrid_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hybrid_top.tcl
