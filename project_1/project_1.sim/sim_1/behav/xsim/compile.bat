...
REM
REM Generated by Vivado on Sun Nov 02 13:23:03 +0530 2025
...
echo "xvlog --incr --relax -prj tb_hybrid_vlog.prj"
call xvlog  --incr --relax -prj tb_hybrid_vlog.prj -log xvlog.log
